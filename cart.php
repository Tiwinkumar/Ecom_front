            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-10 push-md-1" role="tablist">
                        ...
                        <div id="Soup" class="menu-category">
                            ...
                            <div id="menuSoupContent" class="menu-category-content collapse show">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Chicken Noodle Soup</h6>
                                            <span class="text-muted text-sm">Chicken, Noodle, Masala, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4">Rs.50</span>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Beef Soup</h6>
                                            <span class="text-muted text-sm">Beef, cheese, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> RS.500</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="Burgers" class="menu-category">
                            ...
                            <div id="menuBurgersContent" class="menu-category-content collapse">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">50/50 Burger</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, capsicum, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.99</span>
                                            <button class="btn btn-outline-secondary btn-sm"><a href="cart.php"><span>Add to cart</span></a></button>
                                        </div>
                                    </div>
                                </div>
                                <!-- Menu Item -->
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Barbecue Burger</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, potato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.135</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.165</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="Pizza" class="menu-category">
                            ...
                            <div id="menuPizzaContent" class="menu-category-content collapse">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">Tomato, cheese, green leaves, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.200</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Mozarella Funghi</h6>
                                            <span class="text-muted text-sm">Tomato, cheese, green leaves, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.350</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Cappricciosa</h6>
                                            <span class="text-muted text-sm">Tomato, cheese, green leaves, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.275</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Menu Category / Sushi -->
                        <div id="Non-veg" class="menu-category">
                            ...
                            <div id="menunvContent" class="menu-category-content collapse">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Chicken Shawarma</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, mainese, sauce, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.100</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Chicken Cutlet</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, potato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.120</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Chicken gravy</h6>
                                            <span class="text-muted text-sm">Chicken,onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.180</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="Pasta" class="menu-category">
                            ...
                            <div id="menupastaContent" class="menu-category-content collapse">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Bucatini</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, potato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.110</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Capelini</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, potato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.150</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="Desserts" class="menu-category">
                            ...
                            <div id="menuDessertsContent" class="menu-category-content collapse">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">cream, cheese, sweet, egg</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.200</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Ice-Cream</h6>
                                            <span class="text-muted text-sm">Cone, cream, flavour, milk, sugar</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.50</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Cool Drinks</h6>
                                            <span class="text-muted text-sm">sugar, soda, flavour</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"> Rs.35</span>
                                            <button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body panel-details-container">
                ...
                <!-- Panel Details / Quantity -->
                <div class="panel-details">
                    <h5 class="panel-details-title">
                        <label class="custom-control custom-radio">
                            <input name="radio_title_quantity" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                        </label>
                        <a href="#panelDetailsQuantity" data-toggle="collapse">Quantity</a>
                    </h5>
                    <div id="panelDetailsQuantity" class="collapse">
                        <input type="number" class="form-control" min="0" max="5" name="quantity" placeholder="Quantity">
                    </div>
                </div>
