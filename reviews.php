    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="add_review.php" method="POST">
                    <div class="form-group">
                        <textarea cols="30" rows="6" class="form-control" name="review" placeholder="Write here your review..."></textarea>
                    </div>
                    <div class="form-group">
        ...
        <option value="1">1 Star</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="reviewer_designation" placeholder="Your name">
                    </div>
                    <div class="text-center">
                        <button class="btn btn-primary" name="submit">Add review</button>
                    </div>
                </form>
            </div>
        </div>
