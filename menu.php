        ...
        <div class="modal-content">
            ...
            <div class="modal-product-details">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="product-title" style="font-weight: 400;" id="modelname"></h4>
                                    <span class="product-caption text-muted" id="modelcat" ></span>
                    </div>
                    <div class="col-3 text-lg text-right" id="modelrate"></div>
                </div>
            </div>
            <div class="modal-body panel-details-container">
                <!-- Panel Details / Size -->
                <div class="panel-details" style="margin-top: -5%;">
                    <form action="process_cart.php" method="POST">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control text-center input-qty form-control-lg" name="name" style="visibility: hidden;" id="mname"  value="" >
                                        </div>
                                        <div class="form-group ">
                                           
                                            <input type="text" class="form-control text-center input-qty form-control-lg" name="category" style="visibility: hidden;" id="mcat"  value="">
                                        </div>
                                        <div class="form-group ">
                                            <input type="text" class="form-control text-center input-qty form-control-lg" name="rate" style="visibility: hidden;" id="mprice"  value="">
                                        </div>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.addtocart', function(){
    ...
    var name = $(this).siblings('#nam').text();
    var cat = $(this).siblings('#cate').text();
    var rate = $(this).siblings('.item_rate').text();
