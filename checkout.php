...
<?php
            ...
            ?>   
                    ...
                    <tr>
                        ...
                        <td class="actions" style="padding-right: -20%;">
                ...
                <div class="cart-summary">
                    ...
                    <div class="col-xl-8 pull-xl-4 col-lg-7 pull-lg-5">
                        ...
                        <div class="form-group col-sm-12" style="visibility: hidden;">
                                    <input type="text" name="total" value="<?php echo $tot;  ?>" class="form-control">
                                </div>
                        <div class="text-center" style="margin-top: -20%;">
                            <button class="btn btn-primary btn-lg" type="submit" id="x" name="submit"><span>Order now!</span></button>
                        </div>
                        </form>
                    </div>
                </div>
