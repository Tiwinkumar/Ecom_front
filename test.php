...
<?php
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Soup' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm"><?php echo  $row[3] ; ?></span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4">Rs.<?php echo  $row[4] ; ?></span>
                                            <a href="cart-add.php?id=<?php echo  $row[0] ; ?>" class="btn btn-outline-secondary btn-sm"><span>Add to cart</span></a>
                                        </div>
                                    </div>
                                </div>
<?php
...
<?php
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Burger' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
...
<?php
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Pizza' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
...
<?php
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Non-veg' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
...
// close database connection
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Pasta' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
...
// close database connection
            ...
            // figure out the total pages in the database
            if ($result = $mysqli->query("SELECT * FROM add_soup WHERE item_category='Desserts' "))
            {
            if ($result->num_rows != 0)
            {
            $total_results = $result->num_rows;
