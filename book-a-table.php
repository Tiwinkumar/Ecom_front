                    ...
                    <div class="col-lg-6 push-lg-3">
                        ...
                        <div class="utility-box">
                            ...
                            <form action="book.php"  method="post">
                                <div class="utility-box-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Date:</label>
                                                <input type="date" name="datebook" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <button class="utility-box-btn btn btn-secondary btn-block btn-lg btn-submit" type="submit" id="x" name="submit">
